...
def _print_clean_summary(plan: InstallPlan, cve_check_requested: bool = False) -> None:
    ...
    if plan.deployment:
        d = plan.deployment
        tier_label = {"simple": "Simple", "pro": "Pro", "wrap": "Auto-Wrap"}.get(d.packaging_tier, d.packaging_tier)
        tier_color = {"simple": "green", "pro": "yellow", "wrap": "red"}.get(d.packaging_tier, "white")
